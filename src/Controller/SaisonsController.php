...
class SaisonsController extends AbstractController
{
    ...
    {
        return $this->render('admin/saisons/index.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('admin/saisons/new.html.twig', [
            'saison' => $saison,
    ...
    {
        return $this->render('admin/saisons/show.html.twig', [
            'saison' => $saison,
        ]);
    }
    ...
    public function edit(Request $request, Saisons $saison): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin/saisons_index');
        }
